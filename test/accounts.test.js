...
test("SSH-created account can log in and public registration is absent", async () => {
  ...
  try {
    ...
    const appResponse = await fetch(`${baseUrl}/app.js?v=43`);
    ...
    assert.match(appSource, /sw\.js\?v=43/);
    const pronunciationResponse = await fetch(`${baseUrl}/pronunciation-data.js?v=43`);
